...
# If cross-compiling (no LOCALAPPDATA), install in `bin`.
...
# ANGLE.
# Keep this on chromium/6601.2 for the Godot 4.4 thirdparty ANGLE headers.
angle_version = "chromium/6601.2"
...
if platform.system() == "Windows":
    # Only download MSVC libraries if we can build using them.
...
print(f'{Ansi.GREEN}All ANGLE components were installed to "{deps_folder}" successfully!{Ansi.RESET}')
print(f'{Ansi.GREEN}You can now build Godot with statically linked ANGLE by running "scons angle=yes".{Ansi.RESET}')
